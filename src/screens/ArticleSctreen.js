  ...
  return (
    <div>
      ...
      <div className="flex justify-between border border-gray-500">
        ...
        >
          Home
          <img className="w-10 m-2 bg-gray-400 rounded p-1" src="../images/logo1.png" />
        </Link>
      ...
      {article && (
        <div className="flex flex-col justify-center items-center p-5">
          ...
          <img className='p-4' src={article[0].urlToImage} alt='article image' />
          ...
          <p className='text-l text-white p-3'>Published: {moment().from(article[0].publishedAt)} ago</p>
        </div>
      )}
